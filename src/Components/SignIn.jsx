        ...
        <div className="flex flex-col lg:flex-row justify-between">
                    ...
                    <div className="lg:w-[50%] md:px-20 px-5">
                        <div className="text-center pb-3">  
                            ...
                            <h3 className="text-xl md:text-2xl my-4">Sign in to unlock instant <span className="underline">NewTranslator</span></h3>
                        </div>
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 text-black" >
                            ...
                            <input type="submit" value='SIGN IN' className="w-full font-bold bg-blue-500 hover:bg-blue-900 transition duration-300 text-white p-3 mt-3 rounded-4xl" />
                        </form>
